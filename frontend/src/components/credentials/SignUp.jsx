...
const SignUp = () => {
    ...
    return (
        <section className="credentials">
                <h1 class="sm:text-5xl text-2xl font-medium title-font mb-12 text-gray-700 hover:text-black hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer text-center">
                                    ...
                                    <div className="login__form w-full px-6">
                                        <form action="" className="flex flex-col items-start w-full">
                                            <div className="username flex flex-col items-start w-full mb-4">
                                                <label className='text-sm mb-2 font-semibold'>Username</label>
                                                <input 
                                                    type="text" 
                                                    name="username" 
                                                    id="username"
                                            ...
                                            <div className="password flex flex-col items-start w-full mb-4">
                                        ...
                                        <div className="">
                                            <h3 className="xl:text-lg text-xs xl:mb-10 mb-6">
                                        ...
                                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-4">Login</button>
                                    </div>
                                </div>
                            ...
                            <div className="flex justify-around items-center flex-wrap">
                                <div className="mt-10 login xl:w-2/5 w-4/5 lg:w-2/4 md:w-2/3 login__form__color flex flex-col justify-start items-center border-solid rounded-xl border-2"
                                    ...
                                    <div className="login__form w-full px-6">
                                        ...
                                        <div className="">
                                            <h3 className="xl:text-lg text-xs xl:mb-6 sm:mb-6 mb-2">
                                                This information will be securely saved as per <b>Terms of Services & Privacy Policy</b>
                                            </h3>
                                            <div className="cta flex flex-wrap justify-around items-center">
                                                <button className="lg:text-sm text-xs" 
